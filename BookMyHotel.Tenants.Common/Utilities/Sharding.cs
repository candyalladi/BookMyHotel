...
namespace BookMyHotel_Tenants.Common.Utilities
{
    ...
    public class Sharding
    {
        ...
        public Sharding(string catalogDatabase, string connectionString, ICatalogRepository catalogRepository, 
            ITenantRepository tenantRepository, IUtilities utilities)
        {
            try
            {
